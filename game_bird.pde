...
void setup() {
   backpic =loadImage("https://github.com/DanielNatanael/game/blob/main/image/background_game.png");
   birdpic =loadImage("https://github.com/DanielNatanael/game/blob/main/image/birds.png");
   wallpic =loadImage("https://github.com/DanielNatanael/game/blob/main/image/wall.png");
   welcomescreen=loadImage("https://github.com/DanielNatanael/game/blob/main/image/start_game.png");
